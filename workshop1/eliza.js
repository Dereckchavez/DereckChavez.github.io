...
var rules = {
  ...
  "~*x name ~*y": [
 ,
    "DON'T EVEN SAY NOTHING TO ME BOY YOU LOOK LIKE A MOTHERFUCKING UGHHHHHHHHHHH"
  ],
  "~*x sorry ~*y": [
 ,
    "Boy if you don't get yo goofy ass outta here"
...
,
 ...
 ,
  ...
  "~*x I dream about ~*y": [
  ,
    "I dream about getting that bread bro nothing gonna stop me fam"
  ],
  "~*x dream ~*y": [
    ",
  ],
  "~*x my mother ~*y": [
   ",
    "You cant stay here. Go to your fathers house"
  ],
  "~*x my father ~*y": [
    "Your father?",
  ...
  "~*x no ~*y": [
    "
    "Aint no way im gonna let you down",
  ],
  "~*x I was ~*y": [
 ,
    "Ooooo im about to cut that ass bro"
  ],
  "~*x was I ~*y": [
    ",
  ],
  ...
  "~*x yes ~*y": [
    ...
    "BOY IF YO DONT GET YO GOOFY ASS OUTTA HERE"
  ],
  "~*x someone ~*y": [
  ...
  "~*x perhaps ~*y": [
    ...
    "I look like a damn Dr.Phil to you"
